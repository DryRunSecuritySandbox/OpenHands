...
from openhands.server.routes.ai_assistant_config import app as ai_assistant_config_router
from openhands.server.routes.knowledge_search import app as knowledge_search_router
...
app.include_router(ai_assistant_config_router)
